...
- 睡眠也正常，黑屏后移动鼠标唤醒
- 貌似水波纹也正常
- 风扇一直转，虽然，但是，会影响电脑寿命（这个问题通过打补丁也修复了 02-11晚补充）
...
- 没法使用独立显卡 #004
- 没有电池状态 #005(fixed)
- 蓝牙不可用 #006（因为本机无线网卡不带蓝牙，故无法驱动，考虑更换博通网卡解决 02-11晚补充）
...
>>接下来继续优化和完善黑苹果，解决上述小问题和其他问题。并尝试学习hotpatched方法解决问题。本机的黑苹果基本完美，准备制作新的单系统到ssd，开始正常使用。
