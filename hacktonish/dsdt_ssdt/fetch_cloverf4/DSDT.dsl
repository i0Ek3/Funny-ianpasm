 ...
 *
 * Disassembly of DSDT.aml, Thu Feb  8 18:58:03 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001145F (70751)
 *     Revision         0x02
 *     Checksum         0x79
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
 ...
 */
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I", 0x00000034)
{
    /*
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xC97A8C18, 0x02BE)
    ...
    Method (_WAK, 1, Serialized)  // _WAK: Wake
    {
        ...
        If (LOr (LEqual (Arg0, 0x03), LEqual (Arg0, 0x04)))
        {
            ...
            Store (\_SB.PCI0.LPCB.EC.LIDS, \_SB.PCI0.GFX0.CLID)
